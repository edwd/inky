    ...
    case this.components.spacer:
      ...
      if (element.attr('size-sm') || element.attr('size-lg')) {
        ...
        if (element.attr('size-sm')) {
          ...
          html += '<table class="%s hide-for-large"><tbody><tr><td %s height="'+size+'" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>';
        }
        if (element.attr('size-lg')) {
          size = (element.attr('size-lg'));
          html += '<table class="%s show-for-large"><tbody><tr><td %s height="'+size+'" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>';
        }
      } else {
        size = (element.attr('size')) || 16;
        html += '<table class="%s"><tbody><tr><td %s height="'+size+'" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>';
      }
